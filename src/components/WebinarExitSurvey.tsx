...
const REASONS = [
  "I'm not sure what I'll learn",
  "I wanted to know more before paying",
  "₹99 feels expensive right now",
  "I'm not sure this webinar is for me",
  "I don't have time for it right now",
  "I'm not convinced it'll help me",
  "I had another concern",
  "Other",
];

export default function WebinarExitSurvey() {
  ...
  return (
    <div
      className="webinar-exit-overlay"
      role="dialog"
      aria-modal="true"
      aria-labelledby="webinar-exit-title"
    >
      <div className="webinar-exit-card">

        {!submitted ? (
          <>
            <button
              type="button"
              className="webinar-exit-close"
              aria-label="Close"
              onClick={closeSurvey}
            >
              ×
            ...
            <div className="webinar-exit-eyebrow">
              BEFORE YOU GO… 👀
            </div>

            <h2 id="webinar-exit-title">
              What stopped you from joining the webinar?
            </h2>

            <p className="webinar-exit-subtitle">
              Your answer helps us make the webinar
              more useful.
            </p>

            <div className="webinar-exit-options">
              {REASONS.map((reason) => (
                <button
                  type="button"
                  key={reason}
                  className={`webinar-exit-option ${
                ...
                >
                  <span className="webinar-exit-radio">
                    {selectedReason === reason
                      ? "✓"
                      : ""}
                  </span>
            ...
            <button
              type="button"
              className="webinar-exit-dismiss"
              onClick={closeSurvey}
            >
              No thanks
            </button>
          ...
          <div className="webinar-exit-thanks">

            <div className="webinar-exit-thanks-mark">
              ✓
            </div>
            ...
            <p>
              ...
              trying to make the webinar more useful.
            </p>
      ...
      <style jsx global>{`
        ...
        .webinar-exit-option:hover,
        .webinar-exit-option.selected {
          border-color: #111111;
        ...
        .webinar-exit-submit:hover:not(:disabled) {
          background: #111111;

          color: #ffffff;
        }

        .webinar-exit-submit:disabled {
          opacity: 0.45;

          cursor: not-allowed;
        }

        .webinar-exit-dismiss {
          display: block;
